...
Diane Kim
28/06/21
V2 - Added function to change conversion direction
"""
...
class Converter:
    def __init__(self):
        ...
        self.from_variable_label = Label(self.converter_frame, text="Celsius", font=("Garamond", "14"), bg=background_color, pady=5)
        ...
        self.change_temp_button = Button(self.converter_frame, text="Change Conversion Direction", font=("Garamond", "14"), command=self.change_direction)
    ...
    def change_direction(self):
        ...
        background_color = "light pink"
        self.from_variable_label = Label(self.converter_frame, text=from_variable, font=("Garamond", "14"), bg=background_color, pady=5, padx=20)
        self.from_variable_label.grid(row=2, column=0)
        self.to_variable_label = Label(self.converter_frame, text=to_variable, font=("Garamond", "14"), bg=background_color, pady=5, padx=20)
        self.to_variable_label.grid(row=2, column=2)
