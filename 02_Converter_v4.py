...
class Converter:
    ...
    def convert(self):
        ...
        while not valid:
            if result or result == 0:
                ...
                if check:
                    ...
                    check = False
                self.conversion_label = Label(self.converter_frame, text="Invalid", font=("Garamond", "14"), bg="misty rose", pady=5, width = 10)
        ...
        if valid:
            ...
            self.conversion_label = Label(self.converter_frame, text=converted.__round__(2), font=("Garamond", "14"), bg="misty rose", width=10, pady=5)
            self.conversion_label.grid(row=4, column=2)
            print(converted)
